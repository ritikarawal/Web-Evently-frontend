    ...
    <main className="min-h-screen bg-pink-50 text-black">
      ...
      <header className="flex justify-between items-center px-12 py-8">
        ...
        <div className="flex gap-4 items-center">
          <Link href="/register" className="px-5 py-2 text-sm">Sign Up</Link>
          <Link href="/login" className="px-6 py-2 rounded-full bg-rose-900 text-white text-sm">Log in</Link>
        </div>
      </header>
